  ...
  <Sidebar class="!w-full m-4 overflow-x-hidden">
    <SidebarWrapper class="!rounded-none overflow-x-hidden">
      <SidebarGroup>
        ...
        <SidebarDropdownWrapper label="E-commerce" isOpen>
          <svelte:fragment slot="icon">
        ...
        <SidebarItem label="Inbox" {spanClass}>
          ...
          <svelte:fragment slot="subtext">
            <span
              class="inline-flex justify-center items-center p-3 ml-3 w-3 h-3 text-sm font-medium text-white bg-gray-800 rounded-full dark:bg-blue-900 dark:text-blue-200"
              >3</span
            >
          </svelte:fragment>
        </SidebarItem>
